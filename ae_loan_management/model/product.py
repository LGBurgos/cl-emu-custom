...
class ProductProduct(models.Model):
    ...
    def view_customer_invoice_lines(self):
        self.ensure_one()
        action = self.env.ref('ae_loan_management.action_invoice_line_product')
        result = action.read()[0]
        return result

    def view_vandor_bill_lines(self):
        self.ensure_one()
        action = self.env.ref('ae_loan_management.action_vendor_bill_line_product')
        result = action.read()[0]
        return result
...
class ProductTemplate(models.Model):
    ...
    def view_customer_invoice_lines(self):
        self.ensure_one()
        action = self.env.ref('ae_loan_management.action_invoice_line_product_tem')
        result = action.read()[0]
        return result

    def view_vandor_bill_lines(self):
        self.ensure_one()
        action = self.env.ref('ae_loan_management.action_vendor_bill_line_product_tem')
        result = action.read()[0]
        return result
