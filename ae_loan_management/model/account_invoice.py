...
class AccountInvoice(models.Model):
    ...
    def action_loan_lines(self):
        ...
        result = self.env['ir.actions.act_window']._for_xml_id('ae_loan_management.action_loan_line_view')
        ...
        #     result['views'] = [(self.env.ref('ae_loan_management.account_loan_line_form', False).id, 'form')]
