...
class MoveDueDate(models.TransientModel):
    ...
    def postpone_invoices(self):
        ...
        if self.due_date_selection == 'reset':
            ...
            principal_product = int(config_param_obj.get_param('ae_loan_management.principal_prod_id'))
            interest_product = int(config_param_obj.get_param('ae_loan_management.interest_prod_id'))
